// Referans prototipteki çizgi ikonlar (stroke=currentColor, renk CSS'ten gelir).
...
export function IconRapor() {
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
      <path d="M6 2.5h8l4 4V21a.5.5 0 0 1-.5.5h-11A.5.5 0 0 1 6 21z" />
      <path d="M14 2.5V7h4M9.5 12.5h5M9.5 16h5" />
    </svg>
  )
}

export function IconFilo() {
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="5.5" cy="17" r="3.3" />
      <circle cx="18.5" cy="17" r="3.3" />
      <path d="M5.5 17l4.5-8.5h4.2l3.3 8.5M9 8.5h4.5" />
    </svg>
  )
}
